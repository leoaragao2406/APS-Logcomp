...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EMIT = 7,                       /* EMIT  */
  YYSYMBOL_WAIT = 8,                       /* WAIT  */
  YYSYMBOL_TICKS = 9,                      /* TICKS  */
  ...
  YYSYMBOL_45_3 = 45,                      /* $@3  */
  YYSYMBOL_emit_stmt = 46,                 /* emit_stmt  */
  YYSYMBOL_wait_stmt = 47,                 /* wait_stmt  */
  YYSYMBOL_halt_stmt = 48,                 /* halt_stmt  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LET", "IF", "LOOP",
  "TIMES", "EMIT", "WAIT", "TICKS", "HALT", "READ", "ON", "OFF", "NOT",
  "AND", "OR", "\"==\"", "\"!=\"", "\">=\"", "\"<=\"", "IDENT", "NUMBER",
  "'>'", "'<'", "'+'", "'-'", "'*'", "'/'", "'='", "';'", "'('", "')'",
  "'{'", "'}'", "$accept", "program", "statement_list", "statement",
  "var_decl", "$@1", "assign", "conditional", "$@2", "loop", "$@3",
  "emit_stmt", "wait_stmt", "halt_stmt", "param", "condition",
  "comparison", "expr", YY_NULLPTR
};
...
{
     -70,     3,    76,   -70,   -20,   -16,    43,     0,    43,    -1,
      -5,   -70,   -70,   -70,   -70,   -70,   -70,   -70,   -70,     7,
      39,     6,   -70,   -70,    43,    19,    27,    50,   -70,    43,
     -70,    11,    40,    75,    30,    79,   -70,    43,    43,    43,
      43,   -70,   -70,    36,    62,    37,    87,    43,    39,    39,
      39,   -70,   -70,   -70,   -70,   -70,   -70,   -70,    43,    25,
     -70,    38,    35,    35,   -70,   -70,   -70,   -70,   -70,    93,
      53,   -70,    58,    49,    62,   -70,   -70,   -70,   -70,   -70,
       1,     9,   -70,   -70
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,    41,    40,     0,     0,     0,     0,    21,     0,
      12,     0,     0,     0,     0,     0,    17,     0,     0,     0,
       0,    23,    24,     0,    22,     0,     0,     0,     0,     0,
       0,    15,    31,    34,    32,    33,    29,    30,     0,     0,
      39,     0,    35,    36,    37,    38,    19,    20,    14,     0,
       0,    27,    28,     0,    25,    42,     4,    13,    26,     4,
       0,     0,    18,    16
};
...
static const yytype_int8 yypgoto[] =
{
     ...
     -70,   -70,   -70,   -70,   -70,   -22,   -70,    -6
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     2,    11,    12,    47,    13,    14,    73,    15,
      61,    16,    17,    18,    43,    32,    58,    33
};
...
{
      25,    19,    27,     3,     4,     5,     6,    80,     7,     8,
      81,     9,     4,     5,     6,    20,     7,     8,    35,     9,
      44,    26,    10,    46,    29,    36,    70,    71,    72,    28,
      10,    62,    63,    64,    65,    82,    30,    34,    21,    41,
      42,    69,    48,    83,    37,    38,    39,    40,    22,    23,
      21,    59,    74,    31,    21,    49,    50,    75,    24,    45,
      22,    23,    39,    40,    22,    23,    66,    67,    49,    50,
      24,    76,    51,    49,    24,    37,    38,    39,    40,     4,
       5,     6,    79,     7,     8,    78,     9,    37,    38,    39,
      40,     0,    52,    53,    54,    55,     0,    10,    56,    57,
      37,    38,    39,    40,    37,    38,    39,    40,     0,     0,
       0,    60,    37,    38,    39,    40,     0,    68,    37,    38,
      39,    40,     0,    77
};

static const yytype_int8 yycheck[] =
{
       6,    21,     8,     0,     3,     4,     5,    76,     7,     8,
      79,    10,     3,     4,     5,    31,     7,     8,    24,    10,
      26,    21,    21,    29,    29,     6,    48,    49,    50,    30,
      21,    37,    38,    39,    40,    34,    29,    31,    11,    12,
      13,    47,    31,    34,    25,    26,    27,    28,    21,    22,
      11,    21,    58,    14,    11,    15,    16,    32,    31,     9,
      21,    22,    27,    28,    21,    22,    30,    30,    15,    16,
      31,    33,    32,    15,    31,    25,    26,    27,    28,     3,
       4,     5,    33,     7,     8,    32,    10,    25,    26,    27,
      28,    -1,    17,    18,    19,    20,    -1,    21,    23,    24,
      25,    26,    27,    28,    25,    26,    27,    28,    -1,    -1,
      -1,    32,    25,    26,    27,    28,    -1,    30,    25,    26,
      27,    28,    -1,    30
};
...
{
       0,    36,    37,     0,     3,     4,     5,     7,     8,    10,
      21,    38,    39,    41,    42,    44,    46,    47,    48,    21,
      31,    11,    21,    22,    31,    52,    21,    52,    30,    29,
      29,    14,    50,    52,    31,    52,     6,    25,    26,    27,
      28,    12,    13,    49,    52,     9,    52,    40,    31,    15,
      16,    32,    17,    18,    19,    20,    23,    24,    51,    21,
      32,    45,    52,    52,    52,    52,    30,    30,    30,    52,
      50,    50,    50,    43,    52,    32,    33,    30,    32,    33,
      37,    37,    34,    34
};
